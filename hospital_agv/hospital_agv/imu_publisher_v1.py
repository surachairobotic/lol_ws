...
class IMUPublisher(Node):
    def __init__(self):
        ...
        self.timer = self.create_timer(1/100, self.publish_magnet)
        self.timer = self.create_timer(1/100, self.publish_imu)
    ...
    def publish_imu(self):
        ...
        self.get_logger().info(f"Orien: qx={self.imu.orientation.x}, qy={self.imu.orientation.y}, qz={self.imu.orientation.z}, qw={self.imu.orientation.w}")
